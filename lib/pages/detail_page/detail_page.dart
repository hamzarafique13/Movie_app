...
import 'package:movie_app_use_riverpod/pages/detail_page/deatil_page_responsive.dart';
...
class DetailMovie extends ConsumerStatefulWidget {
  DetailMovie(this.movie, {super.key});
  MovieModel movie;

  @override
  ConsumerState<ConsumerStatefulWidget> createState() => _DetailMovieState();
}

class _DetailMovieState extends ConsumerState<DetailMovie>
                      ...
                      children: [
                        Padding(
                          padding: const EdgeInsets.only(
                              left: 20, top: 18, right: 26, bottom: 10),
                          child: Row(
                              ...
                              InkWell(
                                ...
                                onTap: () {
                                  ...
                                  if (watchlist.contains(dbMovie)) {
                                    ref
                                        .read(
                                            watchListmoviePageProvider.notifier)
                                        .removeMovieToWatchList(dbMovie);
                                    // ref
                                    //     .read(
                                    //         watchListmoviePageProvider.notifier)
                                    //     .removeMovieFromIsar(dbMovie);
